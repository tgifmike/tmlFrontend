		...
		<div className="min-h-screen bg-background">
			...
			<section className="mx-auto max-w-6xl px-6 py-14 sm:py-20">
				...
				<div className="mt-14">
					...
					<article className="group mt-6 grid overflow-hidden rounded-3xl border bg-card shadow-sm transition-shadow hover:shadow-lg sm:grid-cols-[280px_1fr]">
						<Link href="/blog/real-world-cost-of-missed-restaurant-line-checks" className="relative block min-h-56 overflow-hidden sm:min-h-full"><Image src="/blog/daily-line-check-real-world-consequences.png" alt="Restaurant manager recording a food temperature during a daily digital line check" fill className="object-cover transition-transform duration-500 group-hover:scale-[1.02]" sizes="(min-width: 640px) 280px, 100vw" /></Link>
						<div className="p-7 sm:p-8"><p className="text-sm font-semibold text-primary">Food Safety &amp; Accountability</p><h2 className="mt-2 text-2xl font-bold tracking-tight"><Link href="/blog/real-world-cost-of-missed-restaurant-line-checks" className="hover:text-primary">The real-world cost of missed restaurant line checks</Link></h2><p className="mt-3 leading-7 text-muted-foreground">What real inspection findings teach operators about daily temperature, sanitation, storage, labeling, and corrective-action checks.</p><div className="mt-5 flex flex-wrap items-center gap-4 text-sm text-muted-foreground"><time dateTime="2026-05-20">May 20, 2026</time><span className="inline-flex items-center gap-1.5"><Clock3 className="h-4 w-4" aria-hidden="true" />8 min read</span></div></div>
					</article>
				</div>
			</section>
		</div>
